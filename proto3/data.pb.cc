...
PROTOBUF_CONSTEXPR Mas::Mas(
  ...
  , /*decltype(_impl_._int32_cached_byte_size_)*/{0}
  , /*decltype(_impl_.int64_)*/{}
  , /*decltype(_impl_._int64_cached_byte_size_)*/{0}
  , /*decltype(_impl_.uint32_)*/{}
  , /*decltype(_impl_._uint32_cached_byte_size_)*/{0}
  , /*decltype(_impl_.uint64_)*/{}
  , /*decltype(_impl_._uint64_cached_byte_size_)*/{0}
  , /*decltype(_impl_.sint32_)*/{}
  , /*decltype(_impl_._sint32_cached_byte_size_)*/{0}
  , /*decltype(_impl_.sint64_)*/{}
  , /*decltype(_impl_._sint64_cached_byte_size_)*/{0}
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 21, -1, -1, sizeof(::Mas)},
  { 42, -1, -1, sizeof(::Enum)},
  { 49, -1, -1, sizeof(::Father_Daughter)},
  { 56, -1, -1, sizeof(::Father)},
};
...
const ::_pbi::DescriptorTable descriptor_table_data_2eproto = {
    false, false, 672, descriptor_table_protodef_data_2eproto,
    "data.proto",
...
Types::Types(const Types& from)
  ...
  ::memcpy(&_impl_.double__, &from._impl_.double__,
    ...
    switch (tag >> 3) {
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 114)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Types.string"));
        } else
          goto handle_unusual;
        continue;
      // bytes bytes = 15;
...
void Types::InternalSwap(Types* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(Types, _impl_.double__)>(
          reinterpret_cast<char*>(&_impl_.double__),
          reinterpret_cast<char*>(&other->_impl_.double__));
}
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 114)) {
          ...
          do {
            ...
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "Mas.string"));
...
uint8_t* Mas::_InternalSerialize(
  ...
  // repeated int32 int32 = 3;
  {
    int byte_size = _impl_._int32_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
  ...
  // repeated int64 int64 = 4;
  {
    int byte_size = _impl_._int64_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
  ...
  // repeated uint32 uint32 = 5;
  {
    int byte_size = _impl_._uint32_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
  ...
  // repeated uint64 uint64 = 6;
  {
    int byte_size = _impl_._uint64_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
  ...
  // repeated sint32 sint32 = 7;
  {
    int byte_size = _impl_._sint32_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
  ...
  // repeated sint64 sint64 = 8;
  {
    int byte_size = _impl_._sint64_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
...
// @@protoc_insertion_point(message_byte_size_start:Mas)
  ...
  // repeated int32 int32 = 3;
  {
    ...
    _impl_._int32_cached_byte_size_.store(cached_size,
  ...
  // repeated int64 int64 = 4;
  {
    ...
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._int64_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
  ...
  // repeated uint32 uint32 = 5;
  {
    ...
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._uint32_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
  ...
  // repeated uint64 uint64 = 6;
  {
    ...
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._uint64_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
  ...
  // repeated sint32 sint32 = 7;
  {
    ...
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._sint32_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
  ...
  // repeated sint64 sint64 = 8;
  {
    ...
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._sint64_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Father.Daughter.name"));
        } else
          goto handle_unusual;
        continue;
      default:
